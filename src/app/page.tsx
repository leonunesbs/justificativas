...
const formSchema = z.object({
  ...
  clinicalData: z.string().min(1, 'Dados clínicos são obrigatórios.').toUpperCase(),
...
export default function Home() {
  ...
  const handleEdit = (id: string) => {
    ...
    if (itemToEdit) {
      ...
      form.setValue('clinicalData', itemToEdit.clinicalData);
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <textarea
                          ...
                          placeholder="Digite os dados clínicos"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
            ...
            <Card key={item.id}>
              ...
              <CardContent>
                <div className="mt-2 space-y-1 text-sm text-gray-700">
                  ...
                  <div className="flex justify-between">
                    <span className="font-semibold">Dados Clínicos:</span>
                    <span className="ml-2 truncate">{item.clinicalData}</span>
                  </div>
                  <div className="flex justify-between">
